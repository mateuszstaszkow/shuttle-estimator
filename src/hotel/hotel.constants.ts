...
export const getAgodaHotelBody = (cityId: number,
                                  startDate: string,
                                  endDate: string,
                                  numberOfDays: number,
                                  numberOfPeople: number,
        ...
        "CitySearchRequest": {
            "cityId": cityId, "searchRequest": {
                "searchCriteria": {
                    ...
                    "featureFlagRequest": {
                        ...
                        "enableAgencySupplyForPackages": false,
                        "flags": [{
                ...
                "searchContext": {
                    ...
                    "experiments": {
                        ...
                        "forceByExperiment": [{"id": "FAM-366", "variant": "B"}, {
                            ...
                            "id": "JGCW-202",
                            "variant": "B"
                        }, {"id": "JGCW-204", "variant": "B"}, {"id": "JGCW-264", "variant": "B"}, {
                            "id": "JGCW-299",
                            "variant": "B"
            ...
            "context": {
                ...
                "forceExperimentsByIdNew": [{"key": "FAM-366", "value": "B"}, {
                    ...
                    "key": "TEXT-9339",
                    "value": "Z"
                }, {"key": "UMRAH-B2B", "value": "B"}, {"key": "JGCW-202", "value": "B"}, {
                    "key": "JGCW-204",
                    "value": "B"
                }, {"key": "JGCW-264", "value": "B"}, {"key": "JGCW-299", "value": "B"}, {
                    "key": "JGCW-159",
                    "value": "B"
                }],
                "apo": false,
            ...
            "context": {
                ...
                "experiment": [{"name": "FAM-366", "variant": "B"}, {
                    ...
                    "name": "JGCW-202",
                    "variant": "B"
                }, {"name": "JGCW-204", "variant": "B"}, {"name": "JGCW-264", "variant": "B"}, {
                    "name": "JGCW-299",
                    "variant": "B"
            ...
            "isSSR": true,
            "pricing": {
                "bookingDate": startDate + "T09:30:17.310Z",
                "checkIn": startDate + "T23:00:00.000Z",
                "checkout": "2021-02-06T23:00:00.000Z",
                "localCheckInDate": startDate,
                "localCheckoutDate": "2021-02-07",
                "currency": "PLN",
...
export const getAgodaHotelOptions = (cityId: number,
    ...
    "body": JSON.stringify(getAgodaHotelBody(cityId, startDate, endDate, numberOfDays, numberOfPeople, synchronous)),
    "method": "POST",
    "mode": "cors",
    "credentials": "include"
});
